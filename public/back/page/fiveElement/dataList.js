...
layui.use(['form', 'layer', 'laydate', 'table', 'laytpl', 'ajaxUrl'], function () {
    ...
    var ajaxUrl = ajaxArr.noticesList;
    //列表
    var tableIns = table.render({
      ...
      /*      {field: 'id', title: 'ID', width: 50},
            {field: 'title', title: '会员昵称', minWidth: 100, align: "center"},
            {field: 'content', title: '合成次数', minWidth: 300, align: "center"},
    ...
    function add() {
        var index = layui.layer.open({
            title: "添加",
            type: 2,
            content: "noticesEdit.html?mode=add",
    ...
    function edit(data) {
        var index = layui.layer.open({
            title: "编辑",
            type: 2,
            content: "noticesEdit.html?mode=edit",
            success: function (layero, index) {
                var body = layui.layer.getChildFrame('body', index);
                if (data) {

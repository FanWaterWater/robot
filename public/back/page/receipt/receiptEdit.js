...
layui.use(['form', 'layer', 'layedit', 'laydate', 'upload','ajaxUrl'], function() {
	...
	form.on("submit(public)", function(data) {
		...
		var params={};
			params.qrcode=data.field.image;
		...
		if(pageMode=="add"){
            ajaxUrl = ajaxArr.receiptsAdd.url;
            ajaxType = ajaxArr.receiptsAdd.method;

		}else if(pageMode=="edit"){
            ajaxUrl = ajaxArr.receiptsEdit.url+'/'+data.field.id;
            ajaxType = ajaxArr.receiptsEdit.method;

...
layui.use(['form', 'layer', 'laydate', 'table', 'laytpl', 'ajaxUrl'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'user_id', title: '会员ID', width: 100,align: "center"},
            {field: 'nickname', title: '会员昵称', minWidth: 150, align: "center",templet:function (d) {
                var user = d.user,
                    nickname = "";
                if(user !=null && user !=""){
            ...
            {field: 'phone', title: '会员账号', minWidth: 150, align: "center",templet:function (d) {
                    var user = d.user,
                        phone = "";
                    if(user !=null && user !=""){
                        phone = user.phone;
            ...
            {field: 'order_no', title: '申请订单号', minWidth: 200, align: "center"},
            {field: 'verify_status', title: '审核状态', width: 100, align: "center",templet: '#listVerify_status'},
            {field: 'price', title: '提现金额', minWidth: 150, align: "center"},
            {field: 'alipay', title: '支付宝账户', minWidth: 150, align: "center"},
            {field: 'name', title: '支付宝姓名', minWidth: 150, align: "center"},
         /*   {field: 'user', title: '支付宝姓名', minWidth: 150, align: "center",templet:function (d) {
            ...
            {field: 'status', title: '状态', width: 100, align: "center",templet: '#listStatus'},

	...
	var x, b, w, k, C, S = function(i, a, n) {
		...
		T = function(i) {
			return b && t.close(b.attr("times")), x && x.hide(), j.mine = j.mine || {}, t.open({
				...
				offset: "rb",
				resize: !1,
				content: '<img src="' + (j.mine.avatar || layui.cache.dir + "css/pc/layim/skin/logo.jpg") + '"><span>' + (i ||
					j.base.title || "我的LayIM") + "</span>",
			...
			if (a[0]) {
				...
				return "none" === w.css("display") && w.show(), k && t.close(k.attr("times")), 1 !== s.find("li").length || o[0] ||
					(d || w.css("width", 800), s.css({
						height: w.height()
					}).show(), c.css("margin-left", "200px")), o[0] || (s.append(n(v).render(l)), c.append(n(f).render(l)), I(i), E()),
			...
			var u = C = t.open({
				...
				success: function(a) {
					w = a, a.css({
						"min-width": "500px",
						"min-height": "420px"
					}), I(i), "function" == typeof i.success && i.success(a), Q(), R(a), $(i), U(), q(), layui.each(r.chatChange,
						function(i, a) {
							a && a(_())
		...
		R = function(i) {
			...
			i.css({
				"background-image": e ? "url(" + e + ")" : function() {
					return j.base.initSkin ? "url(" + (layui.cache.dir + "css/modules/layim/skin/" + j.base.initSkin) + ")" :
						"none"
				}()
			})
		},
		...
		K = function(i) {
			...
			var a = e(".layim-chatlist-" + i.type + i.id),
				t = {},
				l = a.index();
			if (i.timestamp = i.timestamp || (new Date).getTime(), i.fromid == j.mine.id && (i.mine = !0), i.system || B(i), G =
				JSON.parse(JSON.stringify(i)), j.base.voice && F(), !w && i.content || l === -1) {
			...
			if (w) {
				...
				//june修改
				a.addClass("layui-anim layer-anim-06 hasNew"), 
		...
		P = function(i) {
			...
			if (j[i.type])
				if ("friend" === i.type) layui.each(j.friend, function(n, l) {
					if (i.groupid == l.id) return layui.each(j.friend[n].list, function(e, t) {
						...
						anim: 6
					}) : (j.friend[n].list = j.friend[n].list || [], e[j.friend[n].list.length] = i, i.groupIndex = n, j.friend[
						n].list.push(i), !0)
				});
				else if ("group" === i.type) {
			...
			if (!a) {
				...
				if ("friend" === i.type) {
					...
					o.find(".layui-layim-list").append(s), o.find(".layim-count").html(j.friend[i.groupIndex].list.length), o.find(
			...
			j[i.type] && ("friend" === i.type ? layui.each(j.friend, function(e, t) {
				layui.each(t.list, function(t, n) {
					if (i.id == n.id) {
						...
						return l.find(".layui-layim-list>li").eq(t).remove(), j.friend[e].list.splice(t, 1), l.find(".layim-count")
							.html(j.friend[e].list.length), 0 === j.friend[e].list.length && l.find(".layui-layim-list").html(
								'<li class="layim-null">该分组下已无好友了</li>'), !0
					}
				})
			}) : "group" === i.type && layui.each(j.group, function(e, t) {
				if (i.id == t.id) return a.find(">li").eq(e).remove(), j.group.splice(e, 1), 0 === j.group.length && a.html(
		...
		ti = {
			...
			chat: function(i) {
				...
				"friend" === e ? l = j[e][t].list[n] : "group" === e ? l = j[e][n] : "history" === e && (l = (a.history || {})[t] ||
					{}), l.name = l.name || l.username || l.groupname, "history" !== e && (l.type = e), z(l)
			},
			tabChat: function(i) {
				O(i)
				//$(".layim-chat-list .layim-this").removeClass("hasNew");
			},
			...
			face: function(i, a) {
				...
				n = '<ul class="layui-clear layim-face-list">' + n + "</ul>", ti.face.index = t.tips(n, i, {
					...
					}), e(document).off("mousedown", ti.faceHide).on("mousedown", ti.faceHide), e(window).off("resize", ti.faceHide)
					.on("resize", ti.faceHide), ii(a)
			},
			faceHide: function() {
